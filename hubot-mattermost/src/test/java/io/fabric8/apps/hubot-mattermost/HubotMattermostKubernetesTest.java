...
package io.fabric8.apps.hubotmattermost;
...
public class HubotMattermostKubernetesTest {
    ...
    @Test
    public void testHubotMattermost() throws Exception {
      	assertThat(client).replicationControllers().haveAtLeast(1, new Condition<ReplicationController>() {
	        ...
	        public boolean matches(ReplicationController replicationController) {
	            return getName(replicationController).startsWith("hubot-mattermost");
	        }
      	});
