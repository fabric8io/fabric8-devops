...
public class LetschatModelProcessor {
    ...
    public Template create() {
        return new TemplateBuilder()
                ...
                .addNewParameter().withName("HUBOT_USERNAME").withValue("fabric8")
                    .withDescription("The username for Hubot to login to the chat service").endParameter()
                .addNewParameter().withName("HUBOT_PASSWORD").withValue("RedHat$1")
                    .withDescription("The password for Hubot to login to the chat service").endParameter()
                    ...
                    .withNewTemplate()
                        ...
                        .withNewSpec()
                            ...
                            .addNewContainer()
                                ...
                                .addNewEnv().withName("LETSCHAT_HUBOT_PASSWORD").withValue("${HUBOT_PASSWORD}").endEnv()
                                .addNewEnv().withName("LETSCHAT_HUBOT_USERNAME").withValue("${HUBOT_USERNAME}").endEnv()
